...
import com.salmee.artai.adapters.DrawingAdapter // Use updated adapter
...
import com.salmee.artai.databinding.FragmentDrawingBinding // Use correct binding
...
class DrawingsFragment : Fragment(), OnImageItemClickListener { // Implement listener
    ...
    private fun observeViewModel() {
        imageViewModel.imagesResult.observe(viewLifecycleOwner) { result ->
            ...
            result.fold(
                onSuccess = { images ->
                    // TODO: Filter images specifically for "Drawings" if needed, based on prompt or backend tag
