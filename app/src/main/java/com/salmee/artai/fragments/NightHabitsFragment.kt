...
import com.salmee.artai.databinding.FragmentNightHabitsBinding
...
class NightHabitsFragment : Fragment() {
    private var _binding: FragmentNightHabitsBinding? = null
    private val binding get() = _binding!!
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentNightHabitsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = HabitsAdapter(MockHabitsData.getNightHabits(requireContext())) { habit ->
